...
export default {
  ...
  methods: {
    ...
    drawPolicitalStatus22() {
      // 基于准备好的dom，初始化echarts实例
      let myChart22 = echarts.init(this.$refs.eacherbox22)
      let nameData = ['外部攻击告警', '横向移动告警', '资产外外连告警', '命中威胁告警', '恶意文件告警'] // 年份
      let data1Arr = [5, 70, 21, 15, 0] // 危机
      let data2Arr = [30, 70, 51, 85, 0] //高危
      let data3Arr = [20, 90, 42, 50, 0] // 中
      let data4Arr = [20, 10, 31, 85, 0] // 低
      ...
      let colorList = ['#DC5656', '#FFA044', '#EAE174', '#3CA6FF']
      let seriesList = []
