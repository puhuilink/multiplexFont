      ...
      <a-form-model :model="formState" :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol">
        ...
        <a-form-model-item label="分派条件">
          <div
            ...
            :key="index">
            <div class="circle" > <center>{{ index+1 }}</center></div>
            <div>
              ...
              <div v-for="(m,i) in map.rules" :key="i">
                <a-select v-model="m.name" style="width: 30%;margin-right: 5px"/>
                <a-select v-model="m.name" style="width: 30%;margin-right: 5px"/>
                <a-select v-model="m.name" style="width: 30%;margin-right: 5px"/>
          ...
          <a-button style="width: 100px;background-color: #2BBC13;color: white"> 增加</a-button>
        </a-form-model-item>
        <a-form-model-item label="分派人">
          <div
            ...
            :key="index">
            <div class="circle">{{ notice.type }}</div>
            <div v-if="index===0">
