...
import TimeSelectorProprietaryConfig from '@/views/design/modules/config/common/TimeSelectorProprietaryConfig'
export default {
  name: 'TimeSelectorConfig',
