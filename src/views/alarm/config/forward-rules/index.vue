<template>
  <div class="ForwardRules">
    ...
    >
      ...
      <!-- / 操作区域 -->
      <template #operation>
        <a-button @click="onDetail" :disabled="!hasSelectedOne" v-action:M003006>查看</a-button>
        <a-button @click="onAdd" v-action:M003007>新增</a-button>
        <a-button @click="onEdit" :disabled="!hasSelectedOne" v-action:M003008>编辑</a-button>
        <a-button @click="onBatchDelete" :disabled="!hasSelected" v-action:M003009>删除</a-button>
