...
!(function(window) {
  ...
  window.define = function(id, deps, factory) {
      ...
      if (!deps.length)
          ...
          // "modules" as dependencies, to provide CommonJS compatibility.
      ...
      window.require.modules[id] = {
          ...
          factory: function() {
              ...
              var returnExports = factory.apply(this, deps.slice(0, factory.length).map(function(dep) {
                  switch (dep) {
                      // Because "require", "exports" and "modules" aren't actual
